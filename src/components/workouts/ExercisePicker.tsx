...
const EXERCISE_LIBRARY: Exercise[] = [
  ...
  { id: "incline_bench", name: "Incline Bench", category: "Chest", type: "weighted", muscle_group: "Chest" },
  { id: "decline_bench", name: "Decline Bench", category: "Chest", type: "weighted", muscle_group: "Chest" },
  ...
  { id: "bent_over_row", name: "Bent Over Row", category: "Back", type: "weighted", muscle_group: "Back" },
  ...
  { id: "ab_wheel", name: "Ab Wheel", category: "Core", type: "bodyweight", muscle_group: "Core" },
  ...
  { id: "rowing", name: "Rowing", category: "Cardio", type: "cardio_distance", muscle_group: "Cardio" },
];
