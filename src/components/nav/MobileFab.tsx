...
import { Plus, Calendar, NotebookPen, Brain, Trophy, Search, X, Crown, GraduationCap } from "lucide-react";
...
export const MobileFab = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-[calc(env(safe-area-inset-bottom)+5.75rem)] right-4 z-50 flex flex-col items-end gap-2 pointer-events-none">
      {open && (
      ...
      <button
        ...
        className="pointer-events-auto h-12 w-12 rounded-full shadow-2xl flex items-center justify-center transition-transform active:scale-90"
        style={{
