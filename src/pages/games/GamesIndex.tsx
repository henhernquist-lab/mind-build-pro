...
const GAMES = [
  ...
  { to: "/games/georgia", title: "Georgia Conquest", emoji: "🗺️", desc: "Capture GA regions by answering questions.", ready: true},
  { to: "/games/dungeon", title: "Algebra Dungeon", emoji: "🎮", desc: "Math-gated dungeon crawler. 5 floors, monsters & treasure.", ready: true},
];
